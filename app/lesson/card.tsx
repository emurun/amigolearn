...
export const Card = ({ id, imageSrc, audioSrc, text, shortcut, selected, onClick, status, disabled, type
  ...
  return (
    <div onClick={() => { }}
      className={cn("h-full border-2 rounded-xl border-b=4 hover:bg-black/5 p-4 lg:p-6 cursor-pointer active:border-b-2",
        ...
        && "border-teal-300 bg-teal-100 hover:bg-teal-100",
    ...
    >
      ...
      <div className={cn("flex items-center justify-between",
        ...
        <p className={cn("text-neutral-600 text-sm lg:text-base",
          ...
          selected && status === "correct" && "text-teal-500",
        ...
        <div className={cn("lg:w-[30px] lg:h-[30px] w-[20px] h-[20px] border-2 flex items-center justify-center rounded-lg text-neutral-400 lg:text-[15px] text-xs font-semibold",
          ...
          selected && status === "correct" && "border-teal-500 text-teal-500",
